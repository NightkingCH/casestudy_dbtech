-- ALTER TABLE app.Mitglied NOCHECK CONSTRAINT CK_UniqueUser
...
INSERT INTO app.Mitglied (AdresseId, Email, Telefon, Vorname, Nachname, Geburtsdatum, ProbezeitVon, ProbezeitBis) 	VALUES ((SELECT AdresseId FROM app.Adresse WHERE Strasse LIKE 'Kantonsstrasse'),'mitglied1@tadaa.com','0778885522','Peter','Maffay','1990-02-18','2016-05-01','2016-11-30');
INSERT INTO app.Mitglied (AdresseId, Email, Telefon, Vorname, Nachname, Geburtsdatum, ProbezeitVon, ProbezeitBis) 	VALUES ((SELECT AdresseId FROM app.Adresse WHERE Strasse LIKE 'Berg'),'mitglied2@tadaa.com','0884445566','Jürgen','Drews','1960-01-01','2016-05-01','2016-11-30');
INSERT INTO app.Mitglied (AdresseId, Email, Telefon, Vorname, Nachname, Geburtsdatum, ProbezeitVon, ProbezeitBis) 	VALUES ((SELECT AdresseId FROM app.Adresse WHERE Strasse LIKE 'Im Acherli'),'mitglied3@tadaa.com','0690696969','Sandra','Bullock','1954-08-31','2016-05-01','2016-11-30');
INSERT INTO app.Mitglied (AdresseId, Email, Telefon, Vorname, Nachname, Geburtsdatum, ProvisorischesMitglied, ProbezeitVon, ProbezeitBis) 	VALUES ((SELECT AdresseId FROM app.Adresse WHERE Strasse LIKE 'Hubermatte'),'mitglied4@tadaa.com','0666666666','Gina-Lisa','Pavarotti','1888-08-18',1,'2016-01-01','2016-03-31');
INSERT INTO app.Mitglied (AdresseId, Email, Telefon, Vorname, Nachname, Geburtsdatum, ProvisorischesMitglied, ProbezeitVon, ProbezeitBis) 	VALUES ((SELECT AdresseId FROM app.Adresse WHERE Strasse LIKE 'Hubermatte'),'mitglied5@tadaa.com','0777777777','Will','Smith','1888-08-18',1,'2016-01-01','2016-03-31');
INSERT INTO app.Mitglied (AdresseId, Email, Telefon, Vorname, Nachname, Geburtsdatum, ProvisorischesMitglied, ProbezeitVon, ProbezeitBis) 	VALUES ((SELECT AdresseId FROM app.Adresse WHERE Strasse LIKE 'Hubermatte'),'mitglied6@tadaa.com','0888888888','Leo','DiCaprio','1888-08-18',1,'2016-01-01','2016-03-31');
INSERT INTO app.Mitglied (AdresseId, Email, Telefon, Vorname, Nachname, Geburtsdatum, ProvisorischesMitglied, ProbezeitVon, ProbezeitBis) 	VALUES ((SELECT AdresseId FROM app.Adresse WHERE Strasse LIKE 'Hubermatte'),'mitglied5@tadaa.com','0777777777','Jaden','Smith-Quark','1888-08-18',1,'2016-01-01','2016-03-31');
...
INSERT INTO invoice.AbonnementTyp (Bezeichnung, Wert, Dauer) VALUES ('Bezeichnung1',1,6);
INSERT INTO invoice.AbonnementTyp (Bezeichnung, Wert, Dauer) VALUES ('Bezeichnung2',2,12);
INSERT INTO invoice.AbonnementTyp (Bezeichnung, Wert, Dauer) VALUES ('Bezeichnung3',3,3);

INSERT INTO invoice.Abonnement (AbonnementTypId, StandbetreiberId, GueltigAb, GueltigBis) VALUES ((SELECT AbonnementTypId FROM invoice.AbonnementTyp WHERE Bezeichnung LIKE 'Bezeichnung1'),(SELECT StandbetreiberId FROM app.Standbetreiber WHERE StandbetreiberId LIKE 1),'2016-10-01', '2016-10-05');
INSERT INTO invoice.Abonnement (AbonnementTypId, StandbetreiberId, GueltigAb, GueltigBis) VALUES ((SELECT AbonnementTypId FROM invoice.AbonnementTyp WHERE Bezeichnung LIKE 'Bezeichnung2'),(SELECT StandbetreiberId FROM app.Standbetreiber WHERE StandbetreiberId LIKE 2),'2016-10-11', '2016-10-16');
